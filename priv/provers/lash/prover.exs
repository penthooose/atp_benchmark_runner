%{
  name: :lash,
  label: "Lash",
  # Lash is THF-only → FOF/CNF/TFF is converted to Lash-safe TH0 first; as a
  # refutation prover it cannot report Satisfiable, so no-conjecture
  # Satisfiable problems are skipped (supports.requires_conjecture?).
  command_template:
